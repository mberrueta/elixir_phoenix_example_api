defmodule Imdb.Repo.Migrations.AddActorsMoviesTable do
  ...
  def change do
    create table :actors_movies, primary_key: false do
      add :actor_id, references(:actors, on_delete: :delete_all, type: :binary_id), primary_key: true
      add :movie_id, references(:movies, on_delete: :delete_all, type: :binary_id), primary_key: true
    end
